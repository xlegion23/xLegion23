...
def justify_format(root, element_id, new_text, length=0):
    ...
    dot_string = ' ' + ('.' * just_len) + ' ' if just_len > 2 else {0: '', 1: ' ', 2: '. '}[just_len]
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 10, 6))
    formatter('age calculation', age_time)

    commit_data, commit_time = perf_counter(graph_commits, acc_date, datetime.datetime.today().isoformat())
